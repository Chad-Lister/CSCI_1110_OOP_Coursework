/*
	...
	***  No changes in UML since it is a seperate class and can be used by TestAccount_ATM.
*/

public class Account_ATM {
	...
	public Account_ATM(int accountId, double accountBalance, double accountAnnualInterestRate) {
		this.id = accountId;
