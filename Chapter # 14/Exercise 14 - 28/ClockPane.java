/*
  Author:  Chad Lister.   ***  Modified from book example  ***
  Date: 06/22/2020
  
  This class modifies the ClockPane class in the book by adding three boolean fields, their getter's and setter's for exercise 14 - 28.
